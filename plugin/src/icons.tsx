...
export type PulseIconKind = "arrow-left" | "bell" | "calendar" | "check" | "chevron-left" | "chevron-right" | "copy" | "external" | "plus" | "refresh";
...
export function PulseIcon({ kind, size = 18 }: { kind: PulseIconKind; size?: number }): React.ReactElement {
  return <svg aria-hidden="true" viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {kind === "calendar" && <><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M16 3v4M8 3v4M3 10h18"/></>}
    {kind === "check" && <path d="m5 12 4 4L19 6"/>}
    {kind === "chevron-left" && <path d="m15 18-6-6 6-6"/>}
    {kind === "chevron-right" && <path d="m9 18 6-6-6-6"/>}
    ...
    {kind === "refresh" && <><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/></>}
  </svg>;
}
